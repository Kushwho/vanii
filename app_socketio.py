...
def initialize_deepgram_connection(sessionId, email, voice):
    ...
    options = LiveOptions(model="nova-2", language="en-IN", filler_words=True, smart_format=True, no_delay=True, keywords=["vaanii:5"], endpointing=200,utterance_end_ms="1000",interim_results=True, numerals=True,vad_events=True)
